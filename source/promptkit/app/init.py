...
PROMPTKIT_GITIGNORE = "# Auto-generated by promptkit — ignore all contents\n*\n"
...
class InitProject:
    ...
    def execute(self, target_dir: Path, /) -> None:
        ...
        self._write_promptkit_gitignore(target_dir)
    ...
    def _write_promptkit_gitignore(self, target_dir: Path, /) -> None:
        gitignore_path = target_dir / PROMPTKIT_DIR / GITIGNORE_FILENAME
        if not self._file_system.file_exists(gitignore_path):
            self._file_system.write_file(gitignore_path, PROMPTKIT_GITIGNORE)
